  ...
  return (
    <section className="w-full bg-[#FFF]">
      <main className="max-w-[80rem] mx-auto px-6 py-[100px]">
        <div className="flex items-center flex-col md:flex-row gap-[4.12rem] justify-between">
          <div className="w-1/2">
            <Image
              src="/about.png"
              alt="/about.png"
          ...
          <div className="flex flex-col items-start gap-[1.25rem] w-1/2">
            ...
            <p className="text-[#646464] text-[1rem] md:text-[1.25rem] font-[400] leading-normal">
              ...
              participants with a well-rounded
              and enriching learning experience in Salesforce administration. Our trainers
              have around 8 years experience on different cloud. Ie. Sales Cloud, Service
              Cloud, Marketing Cloud. Omnistudio, Experience Clouds etc.
            </p>
